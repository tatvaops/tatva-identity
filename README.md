...
| Mode | Env | Behaviour |
| --- | --- | --- |
| Temporarily open (current default) | `PLATFORM_ADMIN_OPEN` unset or not `false` | **Any signed-in account** can use the console. Banner warns operators |
...
| Locking `/admin` to named operators | Set `PLATFORM_ADMIN_OPEN=false` when ready |
