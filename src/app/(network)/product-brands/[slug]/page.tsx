...
import { getBrandAi, getIdentitiBrand, listBrandProducts, listIdentitiProjects, listProductProjectUses, recordIdentitiEvent } from "@/lib/data/identiti";
...
export default async function ProductBrandPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const [products, projects, uses, ai, saved] = await Promise.all([
